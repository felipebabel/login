...
export const RESET_PASSWORD_LOGIN = `${API_BASE_URL}/api/v1/login/reset-password`;
export const RESET_PASSWORD_ACCOUNT = `${API_BASE_URL}/api/v1/account/reset-password`;
...
export const GET_MY_USER_DATA = `${API_BASE_URL}/api/v1/account/get-my-user-data`;
export const DELETE_USER = `${API_BASE_URL}/api/v1/account/delete-user`;
...
export const GET_MY_LOGS = `${API_BASE_URL}/api/v1/account/my-logs`;
